...
def get_tiny(args):
    ...
    val_dataset = data(args, 'val', transform=transform_test, labels_t=labels_t, image_names=image_names,
                       val_names=val_names, val_labels=val_labels)
    train_dataloader = DataLoader(dataset=train_dataset, batch_size=args.bs, shuffle=True, pin_memory=True,
                                  num_workers=args.num_worker)
    val_dataloader = DataLoader(dataset=val_dataset, batch_size=args.bs, shuffle=False, pin_memory=True,
                                num_workers=args.num_worker)
